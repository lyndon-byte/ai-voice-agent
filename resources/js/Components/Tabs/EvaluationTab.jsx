        ...
        <div>
            ...
            {analysis.data_collection_results_list?.length > 0 && (
                <div className="mt-5">
                    ...
                    <div className="overflow-hidden rounded-md border border-gray-200 divide-y divide-gray-100">
        ...
        <Portal>
            ...
            <div className="fixed inset-y-0 right-0 z-50 flex w-[480px] max-w-[95vw] flex-col bg-white shadow-2xl">
                        ...
                        <div>
                            <div className="mb-4 flex items-center justify-between">
                                ...
                                <button
                                    ...
                                    title="Add criterion"
                                    className="flex h-7 w-7 items-center justify-center rounded-md border border-gray-200 bg-white text-gray-600 shadow-sm transition-colors hover:bg-gray-50 hover:border-gray-300 hover:text-gray-900"
                                >
                                        ...
                                        <div key={criterion.id} className="group rounded-xl border border-gray-200 bg-white p-4 transition-shadow hover:shadow-sm">
                                            ...
                                            <div className="mt-2.5">
                                                ...
                                                <textarea
                                                    ...
                                                    rows={3}
                                                    className="w-full rounded-md border border-gray-200 bg-gray-50 px-3 py-2 text-xs text-gray-700 placeholder:text-gray-400 focus:border-blue-500 focus:bg-white focus:outline-none resize-none transition-colors"
                                                />
                                            </div>
                                        </div>
                                    ))}
                ...
                <div className="flex flex-shrink-0 items-center justify-between border-t border-gray-100 bg-gray-50 px-5 py-3">
                    ...
                    <button
                        onClick={onClose}
                        className="rounded-md bg-gray-900 px-4 py-1.5 text-xs font-semibold text-white transition-colors hover:bg-gray-700"
                    >
                        Done
                    </button>
                </div>
        ...
        return (
            <>
                ...
                <div className="mt-3 flex items-center justify-between">
                    <button onClick={handlePrevPage} disabled={prevCursors.length === 0 || conversationsLoading} className="flex items-center gap-1.5 rounded-md border border-gray-200 bg-white px-3 py-1.5 text-xs font-medium text-gray-600 shadow-sm transition-colors hover:bg-gray-50 disabled:cursor-not-allowed disabled:opacity-40">
                        <ChevronLeft className="h-3.5 w-3.5" /> Previous
                    </button>
                    <button onClick={handleNextPage} disabled={!nextCursor || conversationsLoading} className="flex items-center gap-1.5 rounded-md border border-gray-200 bg-white px-3 py-1.5 text-xs font-medium text-gray-600 shadow-sm transition-colors hover:bg-gray-50 disabled:cursor-not-allowed disabled:opacity-40">
            ...
            <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 rounded-md border border-gray-200 bg-white px-3.5 py-2 text-xs font-medium text-gray-700 shadow-sm transition-colors hover:bg-gray-50 hover:border-gray-300"
                    >
